    ...
    for (opt = form->opts; opt; opt = opt->next) {
        ...
        if (opt->type == OC_FORM_OPT_SELECT) {
            ...
            if (vpn->form_attempt == 0
                ...
                && (strcasecmp(opt->name, "username") == 0 || strcasecmp(opt->name, "user") == 0)) {
            ...
            if (strcasecmp(opt->name, "username") == 0 || strcasecmp(opt->name, "user") == 0) {
            ...
            if (vpn->form_pass_attempt == 0
                ...
                && (strcasecmp(opt->name, "password") == 0 || strcasecmp(opt->name, "passwd") == 0)) {
                openconnect_set_option_value(opt,
            ...
            if ((strcasecmp(opt->name, "password") == 0 || strcasecmp(opt->name, "passwd") == 0)
